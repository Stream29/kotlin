...
class BuildMetricsBuildOperationListener(private val buildService: Provider<BuildMetricsService>) : BuildOperationListener, AutoCloseable {
    companion object {
    ...
    override fun finished(
        ...
        println("Finished event: ${operationDescriptor?.details?.javaClass?.simpleName}: ${operationDescriptor?.id}")
