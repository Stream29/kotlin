...
const ModuleFilenameHelpers = webpack.ModuleFilenameHelpers;
...
const { dirname, relative } = require("webpack/lib/util/fs");
const generateDebugId = require("webpack/lib/util/generateDebugId");
