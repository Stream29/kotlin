    ...
    override fun report(
        ...
        when (severity) {
            ...
            CompilerMessageSeverity.EXCEPTION -> {
                ...
                // OUTPUT and EXCEPTION are handled above; the remaining enum values
                // (ERROR, WARNING, STRONG_WARNING, FIXED_WARNING, INFO, LOGGING) are exhaustive here
                // because Kotlin 2.x narrows enum exhaustiveness inside `else` branches.
