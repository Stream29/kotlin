...
public class ForTestCompileRuntime {
    ...
    public static File runtimeJarForTests() {
        return propertyOrDist(KOTLIN_FULL_STDLIB_PATH);
    }
    ...
    public static File minimalRuntimeJarForTests() {
        return propertyOrDist(KOTLIN_MINIMAL_STDLIB_PATH);
    }

    @NotNull
    public static File kotlinTestJarForTests() {
        return propertyOrDist(KOTLIN_TEST_JAR_PATH);
    }

    @NotNull
    public static File reflectJarForTests() {
        return propertyOrDist(KOTLIN_REFLECT_JAR_PATH);
    }
    ...
    public static File scriptRuntimeJarForTests() {
        return propertyOrDist(KOTLIN_SCRIPT_RUNTIME_PATH);
    }

    @NotNull
    public static File distKotlincForTests() {
        return new File(propertyOrDist(KOTLIN_DIST_PATH), "kotlinc");
    }
    ...
    public static File runtimeSourcesJarForTests() {
        return propertyOrDist(KOTLIN_FULL_STDLIB_SOURCES_PATH);
    }

    @NotNull
    public static File stdlibCommonForTests() {
        return propertyOrDist(KOTLIN_COMMON_STDLIB_PATH);
    }

    @NotNull
    public static File stdlibJs() {
        return propertyOrDist(KOTLIN_JS_STDLIB_KLIB_PATH);
    }

    private static File propertyOrDist(String property) {
    ...
    public static File jvmAnnotationsForTests() {
        return propertyOrDist(KOTLIN_ANNOTATIONS_PATH);
    }
