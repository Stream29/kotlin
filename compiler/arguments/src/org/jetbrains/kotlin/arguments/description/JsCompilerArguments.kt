...
val actualJsArgumentsKlibStage by compilerArgumentsLevel(CompilerArgumentsLevelNames.jsArguments) {
    compilerArgument {
...
val actualJsArgumentsLinkingStage by compilerArgumentsLevel(CompilerArgumentsLevelNames.jsArguments) {
    compilerArgument {
        name = "target"
...
val actualJsArgumentsLegacy = actualJsArguments.mergeWith(actualJsArgumentsKlibStage).mergeWith(actualJsArgumentsLinkingStage)
    .mergeWith(actualCommonJsAndWasmArguments).mergeWith(actualCommonJsAndWasmArgumentsKlibStage)
    .mergeWith(actualCommonJsAndWasmArgumentsLinkingStage)