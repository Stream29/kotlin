...
internal abstract class CommonKlibBasedArgumentsImpl(
  ...
  override operator fun contains(key: CommonKlibBasedArgumentsKlibArguments.CommonKlibBasedArgumentsKlibArgument<*>): Boolean = key.id in optionsMap
  ...
  override operator fun contains(key: CommonKlibBasedArgumentsLinkingArguments.CommonKlibBasedArgumentsLinkingArgument<*>): Boolean = key.id in optionsMap
