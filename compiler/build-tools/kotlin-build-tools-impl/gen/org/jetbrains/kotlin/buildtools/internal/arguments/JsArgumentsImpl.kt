...
internal class JsArgumentsImpl(
  ...
  override operator fun contains(key: JsCompilerArguments.JsCompilerArgument<*>): Boolean = key.id in optionsMap
  ...
  override operator fun contains(key: JsCompilerKlibArguments.JsCompilerKlibArgument<*>): Boolean = key.id in optionsMap
  ...
  override operator fun contains(key: JsCompilerLinkingArguments.JsCompilerLinkingArgument<*>): Boolean = key.id in optionsMap

  override fun deepCopy(): JsArgumentsImpl = JsArgumentsImpl(adapter).also { newArgs -> newArgs.applyArgumentStrings(toArgumentStrings()) }
